...
def check_for_rs_links(link):
    ...
    elif    options.host == "megaupload":
        link_list   = finder.get_mu_link_list()
    elif    options.host == "hotfile":
        link_list   = finder.get_hf_link_list()
    elif    options.host == "uploaded":
...
class SearchAtFilesTube(threading.Thread):
    ...
    def __init__(self):
        ...
        try:
            ...
            self.__ftsearch = FilesTubeSearch(args,[options.host],[options.filetype])
...
class SearchAtGoogle(threading.Thread):
    ...
    def __init__(self):
        ...
        try:
            ...
            self.__gsearch = GoogleSearch(args,[options.host],[options.filetype])
